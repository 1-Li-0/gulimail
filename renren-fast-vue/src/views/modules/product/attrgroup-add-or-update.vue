  ...
  <el-dialog
    ...
    <el-form :model="dataForm" :rules="dataRule" ref="dataForm" @keyup.enter.native="dataFormSubmit()"
      ...
      <el-form-item label="所属分类id" prop="catelogId">
        ...
        <el-cascader v-model="dataForm.catelogPath" :props="props" :options="categoryList" filterable
                     placeholder="搜索关键字"></el-cascader>
      </el-form-item>
    </el-form>
...
export default {
  data() {
    return {
      props: {
        value: 'catId', //设置选项的值对应的响应数据字段
        label: 'name', //设置选项标签对应的响应数据字段
        children: 'children' //设置选项标签的子标签
      },
      categoryList: [],
      visible: false,
      dataForm: {
