...
public class AlipayTemplate {
    ...
    private  String notify_url = "http://内网穿透的地址/pay/notify";

    // 页面跳转同步通知页面路径 需http://格式的完整路径，不能加?id=123这类自定义参数，必须外网可以正常访问
    //同步通知，支付成功，一般跳转到成功页
    private  String return_url = "http://member.gulimall.com/memberOrder.do";
    ...
    public  String pay(PayVo vo) throws AlipayApiException {
        ...
        //商品描述，可空 (alipay文档中有很多可以选择使用的请求参数，收单建议使用”time_express“设置绝对过期时间，日期格式yyyy-MM-dd HH:mm:ss)
